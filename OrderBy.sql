--ORDER BY--
--ORDERVBY cümleciği bir SORGU deyimi içerisinde belli bir sutuna göre
...
select * from kisiler ORDER BY adres desc; --DESCENDING (desc) tersten sıralama yapacağımız zaman kullanırız
 --kişiler tablosunda maası buyukten kuçuge sıralayın
