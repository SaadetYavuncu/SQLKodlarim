...
(
	sirket_id int,--ortak degerler							--sirket id ler ortak olduğu için bu field lardan baglantı kuruldu.
	sirket_isim VARCHAR(20)							--sirketler				--siparisler
);													  --100null					--101++
													  --101++				    --102++
INSERT INTO sirketler VALUES(100, 'Toyota');		  --102++					--103++
INSERT INTO sirketler VALUES(101, 'Honda');			  --103++					--104null
INSERT INTO sirketler VALUES(102, 'Ford');										--105null
...
select A.sirket_isim, B.siparis_id, B.siparis_tarihi from siparisler as B
right join sirketler as A
on A.sirket_id=B.sirket_id;s
