...
select * from personel where yas!=21000;
select * from personel where yas <>21000;

-- 7) ismi a harfi ile başlayan personel bilgilerini listeleyiniz.
select * from personel where isim ilike 'a%'; --%işareti ne ile devam ederse etsin demek
...
select * from personel where email not like '%gmail.com'; --% ile arama yaptığımız için null gelmez
...
select * from personel order by yas; --dogal sıralama kucukten buyuge asc
